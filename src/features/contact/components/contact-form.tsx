      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select className="w-full px-3 py-2 bg-black/50 border border-orange-800/50 rounded-md text-orange-100 focus:border-orange-600 focus:outline-none">
            ...
            <option>AI/MCP Integration</option>
        ...
        <Button className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-600 border-0 text-white">
          Send Message
        </Button>
      </div>
    </GlassmorphicCard>
